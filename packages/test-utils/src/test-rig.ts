...
// We import these from core to avoid duplication of strings/logic
import { DEFAULT_GEMINI_MODEL, GEMINI_DIR } from '@google/gemini-cli-core';

const __dirname = dirname(fileURLToPath(import.meta.url));
// packages/test-utils/src -> packages/test-utils -> packages -> root
export const BUNDLE_PATH = join(__dirname, '..', '..', '..', 'bundle/gemini.js');
